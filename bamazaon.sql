...
INSERT INTO Products(Product_Name, Department_Name, Price, Stock_Quantity) value("Perfume ", "Beauty & Care", 50 , 50 );
...
INSERT INTO Products(Product_Name, Department_Name, Price, Stock_Quantity) value("Coffee Maker", "Appliances	", 89 , 30);
